#!/usr/bin/env python3
"""MCP Server Configuration Manager with Interactive Selection UI"""
...
MCP_SERVERS_DB = {
    "Browser Automation": {
        ...
        "skyvern": {
            ...
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "skyvern-mcp"]},
        },
    },
    "Code & Version Control": {
        ...
        "gitlab": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "@modelcontextprotocol/server-gitlab"]},
        },
    },
    "Databases": {
        "postgres": {
        ...
        "mysql": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "@modelcontextprotocol/server-mysql"]},
        },
        "mindsdb": {
            "name": "MindsDB MCP",
            "description": "Connect AI to multiple data sources",
            "repo": "https://github.com/mindsdb/mindsdb_mcp_server",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "mindsdb-mcp"]},
        },
        "sqlite": {
            "name": "SQLite MCP",
    ...
    "Communication": {
        ...
        "gmail": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "gmail-mcp"]},
        },
        "discord": {
            "name": "Discord MCP",
            "description": "Discord server and message management",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "discord-mcp"]},
        },
    },
    "Cloud Platforms": {
        "aws": {
            ...
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "@aws-sdk/mcp-server"]},
        },
        "azure": {
            "name": "Azure MCP",
            "description": "Microsoft Azure services integration",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "azure-mcp"]},
        },
        "cloudflare": {
            "name": "Cloudflare MCP",
            "description": "Cloudflare Workers, KV, R2, D1",
            "repo": "https://github.com/cloudflare/mcp-server-cloudflare",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "cloudflare-mcp"]},
        },
        "kubernetes": {
            "name": "Kubernetes MCP",
            "description": "Kubernetes cluster management",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "k8s-mcp"]},
        },
        "docker": {
            "name": "Docker MCP",
            "description": "Docker container and image management",
            "repo": "https://github.com/docker/mcp-server-docker",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "@docker/mcp-server-docker"]},
        },
    },
    "Productivity & Collaboration": {
        ...
        "airtable": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "airtable-mcp"]},
        },
        "jira": {
            "name": "Jira MCP",
        ...
        "asana": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "asana-mcp"]},
        },
        "trello": {
            "name": "Trello MCP",
            "description": "Trello board and card management",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "trello-mcp"]},
        },
        "monday": {
            "name": "Monday.com MCP",
            "description": "Monday.com workspace management",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "monday-mcp"]},
        },
    },
    "Search & Data Extraction": {
        ...
        "perplexity": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "perplexity-mcp"]},
        },
        "brave-search": {
            "name": "Brave Search MCP",
            "description": "Brave Search API integration",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "brave-search-mcp"]},
        },
        "fetch": {
            "name": "Fetch MCP",
    ...
    "File Systems": {
        ...
        "s3": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "s3-mcp"]},
        },
    },
    "Knowledge & Memory": {
        "obsidian": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "obsidian-mcp"]},
        },
        "memory": {
            "name": "Memory MCP",
    ...
    "Finance": {
        "alpha-vantage": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "alpha-vantage-mcp"]},
        },
        "cryptocompare": {
            "name": "CryptoCompare MCP",
            "description": "Cryptocurrency price and market data",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "cryptocompare-mcp"]},
        },
    },
    "Media Processing": {
        "mermaid": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "@modelcontextprotocol/server-mermaid"]},
        },
        "imagemagick": {
            "name": "ImageMagick MCP",
            "description": "Image processing and manipulation",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "imagemagick-mcp"]},
        },
    },
    "Social Media": {
        "youtube": {
            ...
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "@modelcontextprotocol/server-youtube"]},
        },
        "twitter": {
            "name": "Twitter/X MCP",
            "description": "Twitter/X API integration",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "twitter-mcp"]},
        },
        "reddit": {
            "name": "Reddit MCP",
            "description": "Reddit data and community access",
            "repo": "https://github.com/modelcontextprotocol/servers",
            "config": {"type": "stdio", "command": "npx", "args": ["-y", "reddit-mcp"]},
        },
    },
    "AI & Research": {
        "sequential-thinking": {
        ...
        "context7": {
            ...
            "config": {"type": "http", "httpUrl": "https://mcp.context7.com/mcp"},
        },
        "zen": {
            "name": "Zen MCP",
...
def apply_servers_to_cli(cli_filename: str, selected_servers: Set[str]) -> None:
    ...
    json_files = [f for f in SERVERS_DIR.iterdir() if f.suffix.lower() == ".json" and f.name.endswith(cli_filename)]
...
def deploy_config_to_app_locations(cli_filename: str, selected_servers: Set[str], location_types: List[str] = None) -> None:
    ...
    print(f"\n{Fore.CYAN}Deploying configuration to app locations...{Style.RESET_ALL}\n")
    ...
    for location_type in location_types:
        ...
        if not target_paths:
            if location_type == "project":
                print(f"  {Fore.YELLOW}Skipping {location_type}: no locations configured{Style.RESET_ALL}")
            continue
        ...
        for target_path_raw in target_paths:
            try:
                ...
                if target_path.suffix.lower() == ".toml":
                    # For TOML files, we need to reconstruct the format
                    lines = []
...
def install_all_to_project(config: Dict[str, object]) -> None:
    ...
    # Always use project locations
    locations = APP_LOCATIONS.get("project", {})
    ...
    print(f"\n{Fore.CYAN}Installing {len(selected_servers)} servers to ALL project configurations...{Style.RESET_ALL}\n")
...
def main_menu(llms: List[LLMTemplate], all_servers: Dict[str, object], config: Dict[str, object]) -> None:
    ...
    while True:
        ...
        if selected_llm_filename:
            ...
            if selected_llm:
                print(f"\n{Fore.GREEN}Current CLI: {selected_llm.display_name}{Style.RESET_ALL}")
        else:
            print(f"\n{Fore.RED}Current CLI: None selected{Style.RESET_ALL}")
