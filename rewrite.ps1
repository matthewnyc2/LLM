...
"@
    ...
    "Add .gitignore for Python cache files and project-specific files" = @"
# Project Description
...
"@
    ...
    "Fix critical issues in llm.py identified by verification agents" = @"
# Project Description
...
"@
    ...
    "Consolidate to llm.py only and fix MCP server formatting" = @"
# Project Description
...
"@
    ...
    "Remove main2.py and consolidate to llm.py" = @"
# Project Description
...
"@
    ...
    "Add claude GitHub actions 1763354300262" = @"
# Project Description
...
"@
    ...
    "Fix security vulnerabilities and configuration issues" = @"
# Project Description
...
"@
    ...
    "Fix cross-platform compatibility in all JSON templates" = @"
# Project Description
...
"@
    ...
    "Fix cross-platform compatibility: Replace cmd with npx in JSON templates" = @"
# Project Description
...
"@
    ...
    "Fix Windows-specific command patterns in JSON MCP server templates" = @"
# Project Description
...
"@
    ...
    "Fix MCP server configurations for all LLMs and update metadata" = @"
# Project Description
...
"@
    ...
    "Spawn agents to verify MCP servers" = @"
# Project Description
...
"@
    ...
    "wip: save all unstaged changes before rebase (2025-12-05T02:08:20.729Z)" = @"
# Project Description
...
"@
    ...
    "Add colorful centered UI and WSL support for Codex" = @"
# Project Description
...
"@
    ...
    "Fix MCP server configuration issues across all templates" = @"
# Project Description
